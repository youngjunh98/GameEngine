...
LRESULT CALLBACK WndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
		...
		case WM_MOUSEHOVER:
		{
			auto& input = static_cast<GameEngine::PlatformInput&> (GameEngine::Platform::GetGenericInput ());
	...
	auto& windowsApplication = static_cast<GameEngine::WindowsApplication&> (GameEngine::Platform::GetGenericApplication ());
