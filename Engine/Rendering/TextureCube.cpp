...
namespace GameEngine
{
	...
	bool TextureCube::UpdateTextureResource (const std::vector<TextureResourceData>& resourceData)
	{
		...
		m_textureCube = g_renderer.GetPlatformRenderingInterface ().CreateTexture2D (m_width, m_height, m_mipMapCount, 6, m_format, pixels.data (), pitches.data (), true, true, false, false);
		...
		m_srv = g_renderer.GetPlatformRenderingInterface ().CreateShaderResourceView (m_textureCube.get (), m_format, 0, 1, 0);
