...
namespace GameEngine
{
	...
	public:
		...
		CORE_API friend Matrix4x4 operator* (const float scale, const Matrix4x4& matrix);
		CORE_API friend Vector4 operator* (const Vector4& vector, const Matrix4x4& matrix);
